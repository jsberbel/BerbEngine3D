...
public:
	 ...
	 */
	inline const MouseCoords &GetMouseCoords() const {
	 ...
	 */
	inline Sint32 GetMouseWheel() const {
		return m_mouseWheel; 
	};
	/**
	 ...
	 */
	template<MouseButton btn> bool IsMouseDown() {
	 ...
	 * @return A boolean value that indicates if the event was found.
	 */
	template<MouseButton btn> bool IsMouseHold() {
	 ...
	 * @return A boolean value that indicates if the event was found.
	 */
	template<MouseButton btn> bool IsMouseUp() {
	 ...
	 * @return A boolean value that indicates if the event was found.
	 */
	template<Sint32 key> bool IsKeyDown() {
	 ...
	 * @return A boolean value that indicates if the event was found.
	 */
	template<Sint32 key> bool IsKeyHold() {
	 ...
	 * @return A boolean value that indicates if the event was found.
	 */
	template<Sint32 key> bool IsKeyUp() {
...
private:
	 ...
	 */
	template<Sint32 id, InputValue value> bool CheckInput() {
